...
public class StoryUserAssessment : MonoBehaviour
{
    ...
    private void CheckAssessmentData()
    {
        ...
        AssessmentAPI = StartCoroutine(apiController.GetRequest("/story/viewstoryassessmentdata", $"?historyid={selectedStoryID}", true, (response) => 
        {
...
[System.Serializable]
public class StoryHistoryItemData
{
    public string title;
    public float score;
